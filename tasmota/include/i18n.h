...
#define D_CMND_HOSTPASSWORD "HostPassword"
...
const char HTTP_SNS_DATE_TIME[]          PROGMEM = "{s}"     D_DATE_TIME           "{m}%s"                             "{e}";
const char HTTP_SNS_BATTERY_STATUS[]     PROGMEM = "{s}"     D_BATTERY_STATUS      "{m}%s "   D_UNIT_MILLIVOLT " (%s)" "{e}";                     
const char HTTP_SNS_MEMORY_CARD_STATUS[] PROGMEM = "{s}"     D_MEMORY_CARD_STATUS  "{m}%s"    D_UNIT_PERCENT " (%s)"   "{e}"; 
