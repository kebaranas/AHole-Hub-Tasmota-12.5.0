...
class AsyncWebServerRequest {
  ...
  private:
    ...
    JoinedList<AsyncWebHeader *> _headers;
    JoinedList<AsyncWebParameter *> _params;
    JoinedList<String *> _pathParams;
...
class AsyncWebServer {
  protected:
    AsyncServer _server;
    JoinedList<AsyncWebRewrite*> _rewrites;
    JoinedList<AsyncWebHandler*> _handlers;
...
class DefaultHeaders {
  using headers_t = JoinedList<AsyncWebHeader *>;
  headers_t _headers;
